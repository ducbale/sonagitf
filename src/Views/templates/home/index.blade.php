...
@section('content')
    ...
    @if($listProductNB1->isNotEmpty())
        <div class="wrap-prolist1">
            <div class="wrap-content">
                <div class="owl-prolist1 p-relative" data-aos="fade-up" data-aos-duration="1000">
                    <div class="owl-page owl-carousel owl-theme"
                        data-items="screen:0|items:2|margin:10,screen:425|items:3|margin:10,screen:575|items:4|margin:10,screen:767|items:4|margin:10,screen:991|items:5|margin:10,screen:1199|items:4|margin:10"
        ...
        <div class="wrap_flashsale">
            <div class="wrap-content">
                <div class="title_flashsale" data-aos="fade-up" data-aos-duration="1000">
                    <h2>Flash sale</h2>
                    <a href="flash-sale" class="xemthem_newshome">Xem tất cả <img class="ms-2" src="assets/images/right.png"></a>
                </div>
                <div class="owl_flashsale" data-aos="fade-up" data-aos-duration="1000">
                    <div class="owl-page owl-carousel owl-theme"
                    data-items="screen:0|items:1|margin:10,screen:425|items:1|margin:10,screen:575|items:3|margin:10,screen:767|items:2|margin:10,screen:991|items:3|margin:10,screen:1199|items:3|margin:0"
                    ...
                    data-dots="0" data-animations="" data-nav="0" data-navcontainer="">
                        @foreach ($proFlashsale as $v)
                            @php
                                $flagPro = Func::status($v['status'],'hot');
                                $flagPro1 = Func::status($v['status'],'sale');
                            ...
                            @endif
                                ...
                                <div class="info_flashsale">
                                    @if ($flagPro==true || $flagPro1==true)
                                        <div class="discount_flashsale">
                                        @if ($flagPro==true) Hot . @endif @if ($flagPro1==true)  Sale @endif off {{ $v->discount }}%
                                        </div>
                                    @endif
        ...
        <div class="wrap_quangcao">
            <div class="wrap-content">
                @foreach ($quangcao as $k => $v)
                    <div class="items_quangcao d-flex justify-content-between align-items-center @if($k%2 != 0) flex-row-reverse @endif" data-aos="fade-up" data-aos-duration="1000">
                        <div class="pic_quangcao">
                            <a class="scale-img" href="{{$v['link'] }}"
    ...
    @if($productNB->isNotEmpty())
        <div class="wrap_pronb load-product-home" data-url="{{ url('load-product') }}" data-type="san-pham" data-status="noibat1" data-paginate="4" data-other="1" data-template='List' data-slug="san-pham" data-eshow=".paging-product-home">
            <div class="wrap-content" >
                <div class="title_pronb" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div id="other-product" class="wrap_listnb load-product-home">
                    <div class="wrap-content" data-aos="fade-up" data-aos-duration="1000">
                        <div class="title-list-main">
                            ...
                            <a href="{{$vlist->slug}}" class="xemthem_newshome">Xem tất cả <img class="ms-2" src="assets/images/right.png"></a>
                        </div>
    ...
    @if($doitac->isNotEmpty())
        <div class="wrap_partner">
            <div class="wrap-content">
                ...
                <div class="d-flex justify-content-start flex-wrap flex_partner">
        ...
        <div class="wrap_newshome">
            <div class="wrap-content">
                <div class="title_newshome" data-aos="fade-up" data-aos-duration="1000">
                    ...
                    <a href="bai-viet" class="xemthem_newshome">Xem tất cả <img class="ms-2" src="assets/images/right.png"></a>
                </div>
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div class="owl-page owl-carousel owl-theme"
                    data-items="screen:0|items:1|margin:10,screen:425|items:1|margin:10,screen:575|items:3|margin:10,screen:767|items:2|margin:10,screen:991|items:2|margin:10,screen:1199|items:2|margin:30"
                    data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1"
                    data-touchdrag="1" data-smartspeed="800" data-autoplayspeed="800" data-autoplaytimeout="5000"
                    data-dots="0" data-animations="" data-nav="0" data-navcontainer="">
    ...
    @if($feedback->isNotEmpty())
        <div class="wrap_feedback">
            <div class="wrap-content">
                ...
                <div data-aos="fade-up" data-aos-duration="1000">
                    <div class="owl-page owl-carousel owl-theme"
                    data-items="screen:0|items:2|margin:10,screen:425|items:3|margin:10,screen:575|items:4|margin:10,screen:767|items:4|margin:10,screen:991|items:5|margin:10,screen:1199|items:2|margin:30"
                    data-rewind="1" data-autoplay="1" data-loop="0" data-lazyload="0" data-mousedrag="1"
                    data-touchdrag="1" data-smartspeed="500" data-autoplayspeed="3500" data-dots="0"
                    data-nav="0" data-navcontainer="">
