                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body card-article">
                        ...
                        <div class="row mt-3">
                            ...
                            @endif
                            @if (!empty($configMan->coords1_iframe))
                                <div class="form-group">
                                    <label for="coords1_iframe">
                                        <span>Iframe google 1:</span>
                                        <a class="text-sm font-weight-normal ml-1" href="https://www.google.com/maps"
                                            target="_blank" title="Lấy mã nhúng">(Lấy mã nhúng)</a>
                                    </label>
                                    <textarea class="form-control text-sm code-javascript" name="data[options][coords1_iframe]" id="coords1_iframe"
                                        rows="5" placeholder="Iframe google 1">{{ Func::decodeHtmlChars(Flash::get('coords1_iframe')) ?: Func::decodeHtmlChars(@$options['coords1_iframe']) }}</textarea>
                                </div>
                            @endif
                            <div class="form-group">
