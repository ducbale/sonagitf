            ...
            <div class="row">
                <div class="col-12 col-lg-8">
                    ...
                    @if (!empty($configMan->file))
                        <div class="card mb-4">
                            <div class="card-header">
                                <h5 class="card-title mb-0">File pdf {{ $configMan->title_main }}</h5>
                            </div>
                            <div class="card-body"> 
                                @php
                                $fileDetail = [];
                                ...
                                @endphp
                                @component('component.file', ['fileDetail' => $fileDetail, 'fileAction' => 'file'])
                                @endcomponent
                            </div>
                        </div>
                    @endif
